...
using GioiaApi.Providers;
using GioiaApi.Results;
...
namespace GioiaApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.userName, Email = model.Email,BirthDate=model.bdate,Fname=model.fname,Lname=model.lname };
